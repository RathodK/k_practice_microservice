package com.kiranrathod.authserver.config;
...
public class OAuthConfiguration extends AuthorizationServerConfigurerAdapter {
	 ...
	 * <code>auth-server.yml</code> file stored in the Spring Cloud config github
	 * repository.
	 * 
	 * @return
	 */
	 ...
	 * <br>
	 * 
	 * We also attach the {@link AuthenticationManager} so that password grants can
	 * be processed.
	 */
	@Override
